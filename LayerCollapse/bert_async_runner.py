...
train_with_trainer(model_GP, dataset["train"], dataset["validation" if args.task!="mnli" else "validation_matched"], epochs=args.epochs,
                    eval_batch_size=args.batch_size, train_batch_size=args.batch_size, gp_weight=args.gp, learning_rate=args.lr, task=args.task, lr_decay=args.lr_decay, weight_decay=args.wd, use_sgd=args.use_sgd, grad_accumulation=args.grad_accumulation)
