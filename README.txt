...
Prerequisites:
Before running the code in this repository, ensure that you have installed the required dependencies listed in the requirements.txt file. Additionally, download the necessary files from the following link: Download Files.
